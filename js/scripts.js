...
function createTicker(){var tickerLIs=jQuery(".news ul").children();tickerItems=new Array();tickerLIs.each(function(el){tickerItems.push(jQuery(this).html());});i=0;rotateTicker();}
...
jQuery('.news ul').html(tickerText.substr(0,c++));if(c<tickerText.length+1)
