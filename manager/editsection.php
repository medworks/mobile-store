<?php
	...
	if ($_GET['act']=="del")
	{
		$db->Delete("section"," id",$_GET["did"]);		
		header('location:editsection.php?act=new');	
	}		
        ...
        <div id="main-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!--Top header start-->
                        <h3 class="ls-top-header"> ویرایش دسته</h3>
                        <!--Top header end -->
...
$html.=<<<cd
                                            ...
                                            <tr>
												...
												<a href="addsection.php?act=edit&did={$rows[$i]["id"]}"  >					
