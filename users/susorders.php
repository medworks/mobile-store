        ...
        <div id="main-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!--Top header start-->
                        <h3 class="ls-top-header">سفارشات معلق</h3>
                        <!--Top header end -->
                        <!--Top breadcrumb start -->
                        <ol class="breadcrumb">
                            <li><a href="javascript:void(0);"><i class="fa fa-home"></i></a></li>
                            <li class="active">سفارشات معلق</li>
                        </ol>
                        <!--Top breadcrumb start -->
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">لیست خریدهای معلق</h3>
                                </div>
...
cd;
	...
	$reccount = $db->CountOf("orders"," clid='{$clientid}' AND status = '0'");
